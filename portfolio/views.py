...
def signup(request):
    if request.method == 'POST':
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            user.profile.home_address = profile_form.cleaned_data.get(
                'home_address')
            user.profile.phone_number = profile_form.cleaned_data.get(
                'phone_number') 
            user.profile.location = profile_form.cleaned_data.get(
                'location')  
            user.save()
